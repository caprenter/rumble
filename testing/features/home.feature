...
When visiting the homepage
  ...
  @assets
	...
	Scenario: I am not logged on I should see the introductory text
  	Given I am on "/"
		Then I should see "Rumble Events Bingley brings together the people that care about music in our area, to make sure there are great musical opportunities for everyone now, and into the future."
